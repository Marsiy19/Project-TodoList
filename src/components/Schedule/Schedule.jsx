...
const Schedule = () => {
  ...
  return (
    <div className='list__content w-full h-screen'>
      ...
      <div className="list__container w-[60%] max-sm:w-[90%]  mx-auto py-[10%] ">
        ...
        <div className="bg-white">
            ...
            <ul className=' w-full flex flex-col py-3 gap-1 px-5'>
...

              {
                allTasks?.map(item => (
                  ...
                  <li key={item.id} className='flex items-center justify-between py-2 max-md:flex-col max-md:gap-3'>
